...
class Login extends Core_Controller
{
    ...
    public function submit()
    {
        ...
        if ($row !== false)
        {
            ...
            //make verifier using salt and user pass
				$passcheck = $this->authentication->makeVerifier($identity, $password, $accsalt); // added this using salt

            //compare the new pass verifier with the one in the record
			if ($accpasshash === $passcheck)   // added this using salt
            { 
