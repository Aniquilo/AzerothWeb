...
class Account extends Core_Controller
{
    ...
    public function submit_changepass()
    {
        ...
        $current_shapasshash = $this->authentication->makeHash($this->user->get('identity'), $password);
        ...
        else if ($current_shapasshash != $this->user->get('shapasshash'))
        {
        ...
        $shapasshash = $this->authentication->makeHash($this->user->get('identity'), $newpassword);
        
        //check if the account was affected
        if ($this->authentication->changePassword($this->user->get('id'), $this->user->get('identity'), $newpassword))
        {
            AccountActivity::Insert('Changed account password');

            $this->user->setLoggedIn($this->user->get('id'), $shapasshash);
