...
class SBBCodeParser_Document extends SBBCodeParser_ContainerNode
{
	...
	{
		return array(
			":)" 		=> base_url() . "/template/style/images/emoticons/smile.png",
			":angel:" 	=> base_url() . "/template/style/images/emoticons/angel.png",
			":angry:" 	=> base_url() . "/template/style/images/emoticons/angry.png",
			"8-)" 		=> base_url() . "/template/style/images/emoticons/cool.png",
			":'("	 	=> base_url() . "/template/style/images/emoticons/cwy.png",
			":ermm:" 	=> base_url() . "/template/style/images/emoticons/ermm.png",
			":D" 		=> base_url() . "/template/style/images/emoticons/grin.png",
			"<3" 		=> base_url() . "/template/style/images/emoticons/heart.png",
			":(" 		=> base_url() . "/template/style/images/emoticons/sad.png",
			":O" 		=> base_url() . "/template/style/images/emoticons/shocked.png",
			":P" 		=> base_url() . "/template/style/images/emoticons/tongue.png",
			";)" 		=> base_url() . "/template/style/images/emoticons/wink.png",
			":alien:" 	=> base_url() . "/template/style/images/emoticons/alien.png",
			":blink:" 	=> base_url() . "/template/style/images/emoticons/blink.png",
			":blush:" 	=> base_url() . "/template/style/images/emoticons/blush.png",
			":cheerful:" => base_url() . "/template/style/images/emoticons/cheerful.png",
			":devil:" 	=> base_url() . "/template/style/images/emoticons/devil.png",
			":dizzy:" 	=> base_url() . "/template/style/images/emoticons/dizzy.png",
			":getlost:" => base_url() . "/template/style/images/emoticons/getlost.png",
			":happy:" 	=> base_url() . "/template/style/images/emoticons/happy.png",
			":kissing:" => base_url() . "/template/style/images/emoticons/kissing.png",
			":ninja:" 	=> base_url() . "/template/style/images/emoticons/ninja.png",
			":pinch:" 	=> base_url() . "/template/style/images/emoticons/pinch.png",
			":pouty:" 	=> base_url() . "/template/style/images/emoticons/pouty.png",
			":sick:" 	=> base_url() . "/template/style/images/emoticons/sick.png",
			":sideways:" => base_url() . "/template/style/images/emoticons/sideways.png",
			":silly:" 	=> base_url() . "/template/style/images/emoticons/silly.png",
			":sleeping:" => base_url() . "/template/style/images/emoticons/sleeping.png",
			":unsure:" 	=> base_url() . "/template/style/images/emoticons/unsure.png",
			":woot:" 	=> base_url() . "/template/style/images/emoticons/w00t.png",
			":wassat:" 	=> base_url() . "/template/style/images/emoticons/wassat.png",
			":whistling:" => base_url() . "/template/style/images/emoticons/whistling.png",
			":love:" 	=> base_url() . "/template/style/images/emoticons/wub.png"
		);
	}
	...
	public static function default_bbcodes()
	{
		return array(
			...
			{
                if (preg_match("/^(?:http(?:s)?:\/\/)?(?:www\.)?(?:m\.)?(?:youtu\.be\/|youtube\.com\/(?:(?:watch)?\?(?:.*&)?v(?:i)?=|(?:embed|v|vi|user)\/))([^\?&\"'>]+)/", $content, $matches))
                {
                    $uri = 'https://www.youtube.com/embed/' . $matches[1];
                }
                else
                {
					$uri = $content;
                ...
                return '<iframe width="560" height="315" src="https://www.youtube.com/embed/' . $uri . '" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
            }, 
			...
			new SBBCodeParser_BBCode('ul', function($content, $attribs) {
                $content = preg_replace("/<br[\s|\/|\>]+\>*?/si", "", $content);
                return '<ul>'.$content.'</ul>';
            }, SBBCodeParser_BBCode::BLOCK_TAG),
			new SBBCodeParser_BBCode('ol', function($content, $attribs) {
                $content = preg_replace("/<br[\s|\/|\>]+\>*?/si", "", $content);
