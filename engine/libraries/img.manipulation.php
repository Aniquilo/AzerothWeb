...
class ImageManipulation {
    ...
    public function resizeProper($max_width=100, $max_height=100)
    {
        $original_width = $this->image["sizex"];
        $original_height = $this->image["sizey"];
        ...
        //save
        $this->image["sizey_thumb"] = $new_height;
        $this->image["sizex_thumb"]  = $new_width;
    }
