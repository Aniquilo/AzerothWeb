...
if ( ! function_exists('Item_Classes') )
{
    function Item_Classes()
    {
        global $itemclasses;
...
if ( ! function_exists('Item_FindClass') )
{
...
if ( ! function_exists('Item_Subclasses') )
{
    function Item_Subclasses()
    {
...
if ( ! function_exists('Item_FindSubclass') )
{
    function Item_FindSubclass($class, $subclass)
    {
        ...
        foreach ($itemsubclasses as $i => $data)
        {
            ...
            {
                return ($data['name2'] != '' ? $data['name2'] : $data['name']);
            }
        }
