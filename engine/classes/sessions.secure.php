...
class Secure
{
    ...
    private $cb = true; //Check Browser ?
    private $cib = 0; //Check IP Blocks <number of blocks>

    public function __construct($checkBrowner = true, $checkIpBlocks = 2)
    {
        $this->cb = $checkBrowner;
        $this->cib = $checkIpBlocks;
    }
