...
<nav id="secondary" class="disable-tabbing">
	<ul>
        ...
        <li class="current"><a href="<?=base_url()?>/admin/logs/paymentwall">Paymentwall Logs</a></li>
    ...
    {	
        ...
        if ($(".datatable").length > 0)
        {
            var newsTable = $(".datatable").dataTable(
            {
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": $BaseURL + "/admin/datatable/paymentwall_logs",
                "aoColumnDefs": [ 
