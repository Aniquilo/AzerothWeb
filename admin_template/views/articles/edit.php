...
<nav id="secondary" class="disable-tabbing">
	<ul>
        ...
        <li class="current"><a href="<?=base_url()?>/admin/articles/edit?id=<?php echo $id; ?>">Edit Article</a></li>
	</ul>
</nav>
...
<section id="content">
    <div class="tab" id="maintab">
        ...
        <div class="form">
        	...
        	<form method="post" action="<?php echo base_url(); ?>/admin/articles/submit_edit" name="edit-article" id="edit-article">
                <section>
                  <label for="label">
                    Headline*
                ...
                <section>
                  ...
                  <div>
                    <textarea class="required" id="textarea_s" name="short_text" rows="5"><?php echo stripslashes($row['short_text']); ?></textarea>
                  </div>
                </section>
                ...
                <script>
					...
					{
						updatePreview('<?php echo base_url() . '/uploads/articles/' . $row['image']; ?>', '<?php echo $row['image']; ?>');
					});
				</script>
         	</form>
...
<script type="text/javascript">
	...
	{
		<?php
		if ($formData = $ERRORS->GetFormData('editArticle'))
		{	
			echo '
