...
var $CurrentMap = $('#tp-mainmap-container');
		...
		WarcryQueue('TELEPORTER').add(function()
		{
			$.get($BaseURL + "/ajax/getMapInfo",
				...
				function(data)
				{
					...
					//set the map image
					$('.open-territory').css('background-image', 'url('+$BaseURL+'/template/style/images/maps/'+zone+'.jpg)');
