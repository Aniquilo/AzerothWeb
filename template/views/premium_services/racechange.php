  	...
  	<div class="container_2 account">
        <div class="cont-image">
            ...
            <div class="error-holder">
                <?php $ERRORS->PrintAny('racechange'); ?>
            </div>
   
            <div class="container_4 account_sub_header">
                <div class="grad">
                    <div class="page-title">Race Change</div>
                    <a href="<?php echo base_url(), '/account'; ?>"><?=lang('back_to_account')?></a>
                </div>
            </div>    
      
            <!-- RACE CHANGE -->
            <div class="race-change">
                
                <div class="page-desc-holder">
                    Race Change will cost you <b><?=$price?> gold</b> coins.<br/>
                    The race change cant be reversed, if you want to change to your old race<br/>
                    you will have to repeat the race change.
                </div>
            
                <div class="container_3 account-wide">
                    <div style="padding:30px 0 30px 0;">
            	
                        <form action="<?=base_url()?>/racechange/submit" method="post">
