...
//get the cooldown
$cooldown = $CORE->user->getCooldown('teleport');
            ...
            <div class="teleporter">
                ...
                <div class="container_3 account-wide padding-tele" align="center">            		
                    ...
                    <div class="complete-tele-form active-tele-form" style="display:none; margin:6px 0 0 0;" align="left">
                        ...
                        <form action="<?php echo base_url(); ?>/teleporter/submit" method="post" onsubmit="return OnTeleportSubmit(this);">
                            <?php
                            ...
                            if ($realm->checkCharactersConnection())
                            {
                                if ($characters = $realm->getCharacters()->getAccountCharacters())
                                {
                                    ...
                                    <div style="display:inline-block; margin: 1px 10px 0 4px;">
                                    <select id="character-select" class="character-select" name="character" onchange="return OnCharacterSelect(this);" data-stylized="true">
